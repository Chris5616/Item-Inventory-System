                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img
                                    ...
                                    src="{{ $supplier->image ? asset('storage/suppliers/' . $supplier->image) : asset('assets/img/demo/user-placeholder.svg') }}"
                                    id="image-preview"
                                />
                            ...
                            <div class="card-body">
                                <div class="row row-cards">
                                    <div class="col-md-12">
                                        ...
                                        <x-input name="shop_name" label="Shop name" :value="old('shop_name', $supplier->shop_name)" :required="true"/>
